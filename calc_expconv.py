...
def make_args():
    ...
    parse.add_argument("-i", "--input", help = "The input directory")
    parse.add_argument("-o", "--output", default = os.getcwd(), help = "The output directory, the default is current dir")
    parse.add_argument("-m", "--mat", help = "The mat file")
    parse.add_argument("-g", "--group", help = "The group file")
    parse.add_argument("--mode", choices=["site", "gene"], default= "gene", help = "The model in analysis, site|gene. default: gene")
